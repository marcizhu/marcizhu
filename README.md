...
| **3** | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/black/pawn.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/white/knight.png" width=50px> | <img src="img/blank.png" width=50px> | <img src="img/blank.png" width=50px> | **3** |
...
| **E6** | [C5](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+C5&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD), [C7](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+C7&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD), [D8](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+D8&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD), [F4](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+F4&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD), [F8](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+F8&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD), [G5](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+G5&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD), [G7](https://github.com/marcizhu/marcizhu/issues/new?title=Chess%3A+Move+E6+to+G7&body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD) |
...
| Move | Author |
| :--: | :----- |
| `C4` to `C3` | [ @mishmanners](https://github.com/mishmanners) |
| `D8` to `E6` | [ @KubaRocks](https://github.com/KubaRocks) |
| `C8` to `E6` | [ @innellea](https://github.com/innellea) |
| `E6` to `D8` | [ @marcizhu](https://github.com/marcizhu) |
...
| Total moves |  User  |
| :---------: | :----- |
| 147 | [@marcizhu](https://github.com/marcizhu) |
| 36 | [@KubaRocks](https://github.com/KubaRocks) |
...
| 14 | [@mishmanners](https://github.com/mishmanners) |
