...
| :----: | :---------------------- |
| **C5** | [B6](https://github.com/marcizhu/marcizhu/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+C5+to+B6) |
<!-- END MOVES LIST -->
...
| `B6` to `E6` | [ @vitorbizarra](https://github.com/vitorbizarra) |
